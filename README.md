...
|-------|------|-------------|
| `backend` | string | Backend name (ibm_torino, ibm_fez, ibm_marrakesh, ibm_kingston) |
...
| `latitude` | float | Data center latitude (41.27) |
| `longitude` | float | Data center longitude (-73.78) |
